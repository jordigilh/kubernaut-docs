...
| `remediation_target` | object | Target resource (kind, name, namespace) — constructed by the AA controller from HAPI's `root_owner` tool result, not a direct HAPI response field |
