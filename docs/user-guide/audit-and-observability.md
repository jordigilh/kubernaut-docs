...
| **HolmesGPT API** | Enrichment and investigation; LLM completion and max-token handling (v1.3) | `aiagent.enrichment.completed`, `aiagent.enrichment.failed`, `aiagent.response.complete`, `truncation_detected` |
